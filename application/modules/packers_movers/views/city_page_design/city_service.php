...
<div class="row g-4 mt-5 mb-4">
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/home-shifting-services.jpg') ?>" alt="Home Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/services_modules/packing-moving-services.jpg') ?>'">
            </div>
    ...
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/office-relocation-services.jpg') ?>" alt="Office Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/services_modules/packing-moving-services.jpg') ?>'">
            </div>
    ...
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/car-transportation-services.jpg') ?>" alt="Car Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/services_modules/packing-moving-services.jpg') ?>'">
            </div>
    ...
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/bike.jpg') ?>" alt="Bike Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/services_modules/packing-moving-services.jpg') ?>'">
            </div>
