...
<div class="row g-4 mt-5 mb-4">
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/home-shifting-services.webp') ?>" alt="Home Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/about/packers_movers.jpg') ?>'">
            </div>
    ...
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/office-relocation-services.webp') ?>" alt="Office Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/about/packers_movers.jpg') ?>'">
            </div>
    ...
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/car-transportation-services.webp') ?>" alt="Car Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/about/packers_movers.jpg') ?>'">
            </div>
    ...
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            <div class="pm-city-srv-icon-wrap">
                <img loading="lazy" src="<?= base_url('assets/images/services_modules/bike-transportation-services.webp') ?>" alt="Bike Shifting in <?= $city ?>" onerror="this.src='<?= base_url('assets/images/about/packers_movers.jpg') ?>'">
            </div>
