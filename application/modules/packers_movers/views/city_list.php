...
$this->load->view('template/breadcrumbs', [
    ...
    'description' => 'Professional relocation and shifting services across all major cities in ' . $state . '.',
    'breadcrumbs' => [
        ['label' => 'Home', 'url' => site_url(), 'icon' => 'bi bi-house-door-fill'],
        ['label' => 'Our Branches', 'url' => site_url('our-branches'), 'icon' => 'bi bi-geo-alt-fill'],
        ['label' => $state]
    ]
]);
?>
