            ...
            <div class="row">
                ...
                ?>
                        <div class="col-md-6 col-lg-6 offset-lg-3 wow fadeInUp">
                            <div class="reviews-single-content d-flex" itemprop="review" itemscope itemtype="https://schema.org/Review">
                                ...
                                <div class="reviews-content-text">
                                    <span class="float-left">
                                        <strong itemprop="author" itemscope itemtype="https://schema.org/Person">
                                            <span itemprop="name" class="reviews-author-badge"><?= $r->name ?></span>
                                        </strong>
                                    </span>
                                    <span class="reviews-float-right-span">
                                        <span>
                                            <?php for ($i = 0; $i < $r->stars; $i++) { ?>
                                                <i class="text-warning bi bi-star-fill"></i>
                                            <?php } ?>
                                        </span>
                                        <span class="float-right star-saver blink mr-2 reviews-star-saver-black">
                                    ...
                                    <br>
                                    <h4 class="reviews-title-black">
                                        <q itemprop="name"><?= $r->r_title ?></q>
                                    </h4>
                                    <p class="reviews-text-black"><?= mb_strimwidth($r->r_desc, 0, 150, "..."); ?></p>
                                    <p class="reviews-text-black">
                                        <small class="reviews-text-black-bold"><?= $em ?></small>
                                        <small class="float-right" itemprop="datePublished" content="<?= $pdate ?>" class="reviews-date-yellow"><?= $r->posted_date ?></small>
                                    </p>
                                    <?php if (@$r->r_img) { ?>
                                        <div class="content-icon">
                                            <a target="_blank" href="<?= base_url('assets/uploads/reviewimg/') . $r->r_img ?>" alt="<?= $r->name ?> review <?= $company3 ?>">
                                                <img loading="lazy" class="img4 img-fluid" src="<?= base_url('assets/uploads/reviewimg/thumb/') . $r->r_img ?>" alt="<?= $r->name ?> review <?= $company3 ?>">
                                            </a>
                                        </div>
                                    <?php } ?>
                                    <div class="reviews-reply-box">
                                        <b > Reply from <?= $company3 ?></b><br>
                                        <?php
                                        if ($r->stars == "5") {
                                        ...
                                        ?>
                                        <p class="reviews-reply-text"><?= @$reply ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
