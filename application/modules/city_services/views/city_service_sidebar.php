...
<aside class="service-sidebar">
    ...
    <div class="sidebar-widget widget-premium-cta mb-4">
        ...
        <div class="cta-support-boxes d-flex flex-column gap-3 mb-4">
            ...
            <a href="<?= isset($phonehtml1) ? $phonehtml1 : 'tel:' . $phone1 ?>" class="cta-support-box d-flex align-items-center justify-content-between text-decoration-none">
                <div class="d-flex align-items-center gap-3">
            ...
            <?php else: ?>
            <a href="tel:+918120009727" class="cta-support-box d-flex align-items-center justify-content-between text-decoration-none">
                <div class="d-flex align-items-center gap-3">
                    <div class="cta-support-icon icon-blue d-flex align-items-center justify-content-center">
                        <i class="bi bi-telephone-fill"></i>
                    </div>
                    <div class="cta-support-info">
                        <span class="cta-support-lbl">Alternate Line</span>
                        <strong class="cta-support-num">+91 81200 09727</strong>
                    </div>
                </div>
                <i class="bi bi-chevron-right cta-support-arrow text-blue"></i>
            </a>
