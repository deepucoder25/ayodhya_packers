...
$this->load->view('template/breadcrumbs', [
    ...
    'description' => 'We transport your car safely from ' . $city . ' using flatbed carriers and enclosed trailers with GPS tracking. Whether it\'s a sedan, SUV, or luxury vehicle, every car is insured and delivered damage-free.',
    'breadcrumbs' => [
        ['label' => 'Home', 'url' => site_url(), 'icon' => 'bi bi-house-door-fill'],
        ['label' => 'Branches', 'url' => site_url('our-branches'), 'icon' => 'bi bi-geo-alt-fill'],
        ['label' => 'Car Transportation in ' . $city]
    ]
]);
?>
